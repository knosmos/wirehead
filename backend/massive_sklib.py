    ...
    *[
        ...
        Part(
            **{
                ...
                "dest": TEMPLATE,
                "tool": SKIDL,
                "aliases": Alias({"Crystal"}),
                "ref_prefix": "Y",
                "fplist": [""],
                "footprint": "Crystal:Crystal_0603_1608Metric",
        ...
        Part(
            **{
                ...
                "dest": TEMPLATE,
                "tool": SKIDL,
                "aliases": Alias({"ATSAME70J21A-AN"}),
                "ref_prefix": "U",
                "fplist": ["Package_QFP:LQFP-64_10x10mm_P0.5mm"],
                "footprint": "Package_QFP:LQFP-64_10x10mm_P0.5mm",
                "keywords": "32-bit ARM Cortex-M7 MCU Microcontroller",
                "description": "SAM E70 Microchip SMART ARM Cortex-M7-based MCU, 2048K Flash, 384K SRAM, LQFP64",
                "datasheet": "http://ww1.microchip.com/downloads/en/DeviceDoc/SAM-E70-S70-V70-V71-Family-Data-Sheet-DS60001527D.pdf",
                "pins": [
        ...
        Part(
            **{
                ...
                "dest": TEMPLATE,
                "tool": SKIDL,
                "aliases": Alias({"XTR111AxDGQ"}),
                "ref_prefix": "U",
                "fplist": [
                    "Package_SO:MSOP-10-1EP_3x3mm_P0.5mm_EP2.2x3.1mm_Mask1.83x1.89mm_ThermalVias"
                ],
                "footprint": "Package_SO:MSOP-10-1EP_3x3mm_P0.5mm_EP2.2x3.1mm_Mask1.83x1.89mm_ThermalVias",
                "keywords": "0-20mA 4-20mA Current Loop Transmitter Voltage To Current",
                "description": "0-20mA/4-20mA Current Loop Transmitter, Precision Voltage-To-Current, MSOP-10",
                "datasheet": "https://www.ti.com/lit/ds/symlink/xtr111.pdf",
                "pins": [
        ...
        Part(
            **{
                ...
                "dest": TEMPLATE,
                "tool": SKIDL,
                "aliases": Alias({"AP33771"}),
                "ref_prefix": "U",
                "fplist": ["Package_DFN_QFN:QFN-24-1EP_4x4mm_P0.5mm_EP2.7x2.7mm"],
                "footprint": "Package_DFN_QFN:QFN-24-1EP_4x4mm_P0.5mm_EP2.7x2.7mm",
                "keywords": "USB Type C PD Sink",
                "description": "USB Type-C PD Sink Controller, QFN-24",
